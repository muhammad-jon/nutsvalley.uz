...
export const productsData = {
    en: {
        ...
        homepageName: "Home",
        offerProductsTitle: "We offer for you 👇",
        products: [
            {
                id: 1,
                content: "nuts",
                ...
                offerProducts: [
                    {
                        ...
                        imageSrc: "/assets/images/Dried-fruits-Image.png",
                    },
                    {
                        id: 2,
                        title: "Beans",
                        path: "/products/beans",
                        imageSrc: "/assets/images/Beans-Image.png",
                    },
                ],
                products: [
                    {
                        title: "Peanuts karnel",
                        description:
                    ...
                    {
                        title: "Salted peanuts without peel",
                        description:
...
**NOTE: It’s also recommended to check the market situation 15 days before purchasing to gauge availability and prices for your desired product.**`,
                ...
                offerProducts: [
                    ...
                    },
                    {
                        ...
                        title: "Nuts",
                        path: "/products/nuts",
                        imageSrc: "/assets/images/Nuts-Image.png",
                    },
                ],
                products: [
                    {
                        title: "Prunes Hungarian",
                        description:
...
**NOTE: It’s also recommended to check the market situation 15 days before purchasing to gauge availability and prices for your desired product.**`,
    ...
    ru: {
        ...
        offerProductsTitle: "А еще предлагаем... 👇",
        products: [
            {
                id: 1,
                content: "nuts",
                    ...
                    cards: [
                        {
                            ...
                            body: `
После сбора и сушки орехи сортируются и упаковываются в пищевые материалы, сохраняющие свежесть.`,
                        },
                        {
                            title: "Упаковка:",
                            body: `
...
- **Авиаперевозки (опционально)**: для срочных поставок.`,
                        },
                        {
                            ...
                            body: `
Все поставки проходят проверку качества и сопровождаются необходимыми документами.`,
                        },
                    ],
                },
                ...
                products: [
                    ...
                    {
                        title: "Бланшированные ядра арахиса",
                        description:
                            "Доступны калибры от 5 и выше — доставляем в особых твердых боксах, чтобы избежать повреждения продукции.",
                        type: "Орехи",
                    ...
                    },
                    {
                        ...
                        description:
                            "Соленый арахис доставляется без кожуры — некоторые ядра разделены на две части из-за влияния процесса очистки. ",
                        type: "Орехи",
                        packaging: "Картонная коробка",
                        caliber: "Сплит/5+/6+/7+",
                        imageSrc: "Salted-peanuts-without-peel.png",
                    ...
                    {
                        title: "Жареное ядро арахиса",
                        description:
                            "Жареный ядра арахиса доступны в калибрах 5+/6+/7+. Для удобства доставляем в картонных коробках.",
                        type: "Орехи",
                        packaging: "Картонная коробка",
                        caliber: "5+/6+/7+",
                        imageSrc: "Roasted-peanut-kernel.png",
                    },
                    {
                        ...
                        description:
                            "Покрытый сахарным слоем арахис 5+ калибра. Доставка осуществляется в коробках.",
                        type: "Орехи",
                        packaging: "Картонная коробка",
                        caliber: "5+",
                        imageSrc: "Peanuts-in-sugar.png",
                    ...
                    {
                        title: "Арахис в кунжуте",
                        description:
                            "Аналогичный калибр и у арахиса в кунжуте — 5+. Так же доставляется в коробках ради сохранения товарного вида.",
                        type: "Орехи",
                        packaging: "Картонная коробка",
                        caliber: "5+",
                        imageSrc: "Peanuts-in-sesame.png",
...
- **Чернослив с косточкой:** Отличается насыщенным вкусом и длительным сроком хранения, идеально подходит для перекусов и выпечки.
- **Изюм Султана:** Не содержит косточек, имеет естественную сладость, что делает его идеальным ингредиентом для десертов и выпечки.

## Какое лучшее время для экспорта сухофруктов из Узбекистана?

Лучшее время для покупки сухофруктов в Узбекистане — середина сентября, когда урожай завершен, а продукция полностью высушена и готова к экспорту.

- **Период сбора урожая:** с июля по август.
- **Время сушки:** около 15 дней после сбора урожая (например, чернослив, собранный 20 августа, будет готов к экспорту к 5 сентября).
- **Совет по покупке:** Планируйте закупки около 5 сентября, когда большинство экспортеров имеют достаточные запасы.
  
Обратитесь к календарю ниже, чтобы узнать периоды сбора и покупки ключевых продуктов:

| Продукт           | Период сбора урожая      | Время сушки            | Лучшее время для покупки |
|--------------------|--------------------------|-------------------------|--------------------------|
| Чернослив         | 15 августа–25 сентября   | 5 сентября–10 октября   | 5 сентября               |
| Сушеные абрикосы  | 5 июля–25 июля           | 20 июля–10 августа      | 20 июля                  |
| Золотой изюм      | 15 августа–20 сентября   | 5 сентября–10 октября   | 5 сентября               |
| Изюм Султана      | 15 августа–20 сентября   | 5 сентября–10 октября   | 5 сентября               |
| Черный изюм       | 20 августа–5 октября     | 10 сентября–15 октября  | 10 сентября              |
| Смесь для компота | 5 июля–25 июля           | 20 июля–10 августа      | 20 июля                  |


*Примечание: Календарь предоставлен как ориентировочное руководство. Климатические изменения и другие непредвиденные обстоятельства могут повлиять на указанные даты.*
...
**Также рекомендуется уточнить рыночную ситуацию за 15 дней до покупки, чтобы оценить доступность и цены на нужный вам продукт.**`,
                ...
                products: [
                    ...
                    },
                    {
                        title: "Курага",
                        description:
                            "Представлен широкий выбор сортов: Субхан, Органик, Лодка, Резенная и Индустриал. Продукт подходит как для прямой продажи, так и для кондитерских целей. Возможен подбор нужной влажности и калибра.",
                        type: "Сухофрукты",
                        packaging: "Картонная коробка",
                        caliber: "100-220шт",
                        humidity: "24%",
                    ...
                    },
                    {
                        title: "Изюм Голден",
                        description:
                            "Изюм золотистого оттенка сорта Голден доступен к заказу с точным расчетом количества единиц продукта в 100 граммах веса.",
                        type: "Сухофрукты",
                        packaging: "Картонная коробка",
                        caliber: "100-220шт",
                        humidity: "13% макс",
                    ...
                    {
                        title: "Черный изюм Сояки",
                        description:
                            "Мягкий и нежный изюм, высушенный в тени привлекает потребителей изысканным вкусом. Также доступен точный расчет единиц продукта в 100 граммах веса.",
                        type: "Сухофрукты",
                        packaging: "Картонная коробка",
                        caliber: "80-200шт",
                        humidity: "13%макс",
...
- **Фасоль:**
  1. Ранний сезон — июнь.
  2. Основной сезон — октябрь.
- **Маш и нут:** Сезон сбора начинается в августе для нута и в октябре для маша.

## Есть ли разница между ранней и основной фасолью?
Да, разница заключается в размере и цвете. Фасоль раннего сезона (июнь) имеет более светлый цвет и меньший размер по сравнению с основной, собранной в октябре.

## Какое лучшее время для покупки бобовых в Узбекистане?

Лучшее время для покупки бобовых — середина октября, когда урожай завершен, а продукты полностью готовы к экспорту.

- **Период сбора урожая:** с июля по октябрь.
- **Время сушки:** около 20 дней после сбора урожая.

Обратитесь к календарю ниже:

| Продукт | Период сбора урожая    | Время сушки           | Лучшее время для покупки |
|---------|------------------------|-----------------------|--------------------------|
| Фасоль  | 20 сентября–15 октября | 5 октября–30 октября  | 5 октября               |
| Маш     | 20 сентября–15 октября | 5 октября–1 ноября    | 5 октября               |
| Нут     | 25 июня–10 июля        | 15 июля–25 августа    | 15 июля                 |
...
export const messageData = {
    en: {
        successSent: {
            title: "Thank you, Your request was successfully sent to the specialist.",
            text: "Please, wait for our response!",
            closeName: "Close",
        },
        notSuccessSent: {
            title: "Oops, sorry. This request was not sent for some reason. Kindly ask you to address your request via other contact ways. ",
            text: "When you see this message, the site automatically informs about the error to developers. Soon, it will work! Thanks for your understanding.",
            closeName: "Close",
        },
    },
    ru: {
        successSent: {
            title: "Спасибо, Ваш запрос успешно был отправлен специалистам, ",
            text: "Пожалуйста, ждите обратный ответ специалиста!",
            closeName: "Закрыт",
        },
        notSuccessSent: {
            title: "Упс, что-то не то. Этот запрос почему-то не отправлен. Просили бы направить Ваш запрос с другим способом. ",
            text: "Когда Вы видите это сообщение, сайт автоматически отправить разработчику об ошибке. Скоро заработает! Спасибо за понимание.",
            closeName: "Закрыт",
        },
    },
};
